  ...
  return (
    <div className="font-['Montserrat'] hide-scrollbar text-white bg-black h-screen  w-screen">
      ...
      <div className='h-screen w-screen hide-scrollbar scroll-smooth overflow-scroll'>
        ...
        <div className='Section2 bg-primary/10 h-full w-full mx-auto my-0 pb-14'>
        ...
        <div className='Section4 h-full w-11/12 mx-auto border-b-2 sm:flex sm:items-center overflow-y-hidden my-0'>
          ...
          <div className='h-full w-full sm:hidden overflow-y-scroll hide-scrollbar pb-14'>
            ...
            <img className='w-11/12 mx-auto my-2 rounded-2xl' src="BAKC638.jpg" alt="bakc3" />
          </div>
        ...
        <div className='Section3 bg-primary/10 h-full w-full items-center my-0 pt-5 pb-14'>
          <div className='flex flex-col h-full w-full lg:w-8/12 mx-auto lg:flex-row py-8 lg:py-8 justify-between lg:items-center'>
              ...
              <div className='lg:flex lg:w-9/12 xl:w-7/12 lg:h-full lg:items-center lg:justify-between'>
                <div>
                  ...
                  <div>
                    ...
                    <li className='px-12 w-10/12 sm:w-7/12 mx-auto text-sm mb-1 lg:my-3 text-md lg:px-0 lg:w-10/12'>10% of total supply - team allocation</li>
            ...
            <div className='mt-4 lg:mt-0 lg:mb-16'>
              ...
              <div className='w-full text-center text-xs sm:text-sm font-medium' value="0x2047ab3072B52561596Ce5E0131BDbB7C848538D">0x2047ab3072B52561596Ce5E0131BDbB7C848538D</div>
...
active:text-black
active:border-black lg:hover:bg-white lg:hover:text-black lg:hover:border-black' onClick={() => navigator.clipboard.writeText('0x2047ab3072B52561596Ce5E0131BDbB7C848538D')}>Copy to clipboard</button>
              </div>
            </div>
          </div>
        </div>
